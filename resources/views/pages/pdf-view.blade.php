<html lang="en" dir="ltr" class="fi min-h-screen sf-js-enabled">

<head>


    <meta charset="utf-8">
    <meta name="csrf-token" content="zD6avHoyueGxW5miSPUxlfRdtnPry2d5bsVqc0Q7">
    <meta name="viewport" content="width=device-width, initial-scale=1">



    <title>
        View Filametrics Site - Suchekreuz Local
    </title>
    ...
    <link href="/css/malzariey/filament-daterangepicker-filter/date-range-picker.css?v=dev-main" rel="stylesheet"
        data-navigate-track="">
    <link href="/css/bezhansalleh/filament-google-analytics/filament-google-analytics.css?v=dev-main" rel="stylesheet"
        data-navigate-track="">
    <link href="/css/filament/forms/forms.css?v=3.3.12.0" rel="stylesheet" data-navigate-track="">
    <link href="/css/filament/support/support.css?v=3.3.12.0" rel="stylesheet" data-navigate-track="">
    ...
    <link href="/css/filament/filament/app.css?v=3.3.12.0" rel="stylesheet" data-navigate-track="">
    ...
    <link rel="stylesheet" type="text/css" property="stylesheet" href="/_debugbar/assets/stylesheets?v=1744731126"
        data-turbolinks-eval="false" data-turbo-eval="false">
    <script src="/_debugbar/assets/javascript?v=1744731126" data-turbolinks-eval="false"
    ...
    <style>
        ...
        .phpdebugbar pre.sf-dump .sf-dump-ellipsization {
            display: inline-flex;
        }
        ...
        .phpdebugbar pre.sf-dump .sf-dump-ellipsis-tail {
            flex-shrink: 0;
        }
        ...
        .phpdebugbar pre.sf-dump .sf-dump-virtual {
            font-style: italic
        }
...
<body class="p-6 font-sans text-gray-800 bg-white" style="margin: 0 auto; width: 100%; max-width: 1102px;">
    {{-- Header --}}
    ...
    {{-- Infolist --}}
    <div style="margin: 0 auto; width: 100%; max-width: 1102px;">
        {{ $infolist }}
    </div>
    ...
    <script src="/js/filament/notifications/notifications.js?v=3.3.12.0"></script>
    <script src="/js/filament/support/support.js?v=3.3.12.0"></script>
    <script src="/js/filament/filament/echo.js?v=3.3.12.0"></script>
    <script src="/js/filament/filament/app.js?v=3.3.12.0"></script>
