...
class ActiveUsersTwentyEightDayWidget extends ChartWidget
{
    ...
    protected function initializeData()
    {
        ...
        $lookups = [
            '5' => $this->performActiveUsersQuery('active28DayUsers', 5, $analytics),
            '10' => $this->performActiveUsersQuery('active28DayUsers', 10, $analytics),
            '15' => $this->performActiveUsersQuery('active28DayUsers', 15, $analytics),
        ];
